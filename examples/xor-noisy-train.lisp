;;;; xor-noisy-train.lisp - Entrainement du MLP XOR sur des entrees legerement
...
;;;;   (load "examples/xor-noisy-train.lisp")
;;;;   (neuromuse-gui:gui 'xor)          ; ouvre la fenetre (autre systeme, voir gui.lisp)
;;;;   (train-xor-noisy)                 ; bloquant : le REPL attend la fin
;;;;
...
(unless (and (boundp 'xor) (ann-p xor))
  (make-mlp xor 2 1 2)
...
(defun train-xor-noisy (&key (net 'xor) (iterations 100000) (noise .10)
                              (sleep .001) (verbose nil))
